...
describe('Nurse', () => {
    ...
    it('should be able to choose a doctor and see his/hers patients for the day', () => {
        cy.get('.user-name').should('be.visible')
                .should('contain', 'Ana Reljic');//localStorage.getItem('name'));
    ...
    it('should be able to update patients data', () => {
        ...
        cy.get('input[name="prezime"]').should('be.visible').clear().type(chance.word());
    ...
    it('should be able to add new patients', () => {
        cy.get('ul').should('be.visible');
        cy.get('ul > li:nth-child(4)').should('be.visible').should('contain', 'Nov pacijent').click();
        ...
        cy.get('input[name="datumRodjenja"]').should('be.visible').type('1980-12-12');
